...
namespace wke
{
    ...
    public:
		...
		DECLARE_HANDLER(wkeClientHandler *, ClientHandler);
		DECLARE_HANDLER(wkeBufHandler *, BufHandler);

		//add by rrrfff
		//  [1/15/2015 ASUS]
		DECLARE_HANDLER(wkeEx::ON_CONSOLE_OUTPUT, ConsoleOutputHandler);
		DECLARE_HANDLER(wkeEx::ON_JS_ALERT, JsAlertHandler);
		DECLARE_HANDLER(wkeEx::ON_JS_CONFIRM, JsConfirmHandler);
		DECLARE_HANDLER(wkeEx::ON_JS_PROMPT, JsPromptHandler);
